...
def LR(X, y, pca=False, n_components=0.9, kfolds=5, class_weight=None):
    ...
    clf = AdaBoostClassifier(base_estimator=base_clf, n_estimators=700)
...
'''
Precision: 0.32998559304085884
Recall: 0.8259742873146412
F2-score: 0.6348158984592251
Auc: 0.8790129329507043
'''
